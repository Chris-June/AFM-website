/* Reusable WebGL aurora background component powered by ogl. */
"use client";
...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    const allowMouseInteraction = enableMouseInteraction && !prefersReducedMotion;
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uSpeed: { value: prefersReducedMotion ? 0.12 : speed },
        uScale: { value: scale },
        ...
        uColorSpeed: { value: prefersReducedMotion ? 0.2 : colorSpeed },
        uMouse: { value: new Float32Array([0.5, 0.5]) },
        uMouseInfluence: { value: allowMouseInteraction ? mouseInfluence : 0 },
    ...
    const resize = (): void => {
      ...
      program.uniforms.uResolution.value = [gl.canvas.width, gl.canvas.height, gl.canvas.width / Math.max(gl.canvas.height, 1)];
    };
